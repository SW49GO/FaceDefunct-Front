...
const Home = () =>{
    ...
    <div className="home">
        ...
        <section className="home__intro">
            <h2>En toute simplicité</h2> 
            <h2>Avec tout votre entourage</h2>
        ...
        <section className="home__member">
            ...
            <div className="home__container">
                <div className="home__container-article">
                    <div className="home__container-article-photo">
                        <img className="home__container-article-img" src="./assets/site/home-photo.jpg" alt="tas de photos"/>
                    </div>
                    <div className="home__container-article-text">
        ...
        <section className="home__comment">
            ...
            <div className="home__container">
                <div className="home__container-article">
                    ...
                    <div className="home__container-article-photo">
                        <img className="home__container-article-img" src="./assets/site/home-comment.jpg" alt="un stylo"/>
                    </div>
                </div>
                <div className="home__container-article-button">
                    {auth && (<Link className="button button-a" to={'/register'}>S'inscrire</Link>)}
                </div>
            </div>
        </section>
        ...
        <section className="home__card">
            ...
            <div className="home__container">
                <div className="home__container-article">
                    <div className="home__container-article-photo">
                        <img className="home__container-article-img" src="./assets/site/home-card.jpg" alt="carte condoleance"/>
                    </div>
                    <div className="home__container-article-text">
        ...
        <section className="home__flower">
            ...
            <div className="home__container">
                <div className="home__container-article">
                    ...
                    <div className="home__container-article-photo">
                        <img className="home__container-article-img" src="./assets/site/home-flower.jpg" alt="carte condoleance"/>
                    </div>
                </div>
                <div className="home__container-button">
